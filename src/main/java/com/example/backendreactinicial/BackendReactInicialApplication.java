...
import com.example.backendreactinicial.controllers.PedidoController;
    ...
    public CommandLineRunner demo(InstrumentoRepository instrumentoRepository, CategoriaRepository categoriaRepository) {
        return (args) -> {
            ...
            List<Instrumento> instrumentos = Arrays.asList(
                    new Instrumento("Mandolina Instrumento Musical Stagg Sunburst", "Stagg", "M20", "https://http2.mlstatic.com/D_NQ_NP_764778-MLA40447145988_012020-O.jpg", 2450.0, "G", 28, "Estas viendo una excelente mandolina de la marca Stagg, con un sonido muy dulce, tapa aros y fondo de tilo, y diapasón de palisandro. Es un instrumento acústico (no se enchufa) de cuerdas dobles (4 pares) con la caja ovalada y cóncava, y el mástil corto. Su utilización abarca variados ámbitos, desde rock, folk, country y ensambles experimentales.", categorias.get(0), null),
                    new Instrumento("Pandereta Pandero Instrumento Musical", "DyM ventas", "32 sonajas", "https://http2.mlstatic.com/D_NQ_NP_895881-MLA69104523759_042023-O.jpg", 325.0, "150", 10, "1 Pandereta - 32 sonajas metálicas. Más de 8 años vendiendo con 100 % de calificaciones POSITIVAS y clientes satisfechos !! ", categorias.get(2), null),
                    new Instrumento("Triangulo Musical 24 Cm Percusion", "LBP", "24", "https://http2.mlstatic.com/D_NQ_NP_651934-MLA72060088225_102023-O.jpg", 260.0, "250", 3, "Triangulo Musical de 24 Centímetros De Acero. ENVIOS POR CORREO O ENCOMIENDA: Se le deberán adicionar $40 en concepto de Despacho y el Costo del envío se abonará al recibir el producto en Terminal, Sucursal OCA o Domicilio", categorias.get(2), null),
                    new Instrumento("Bar Chimes Lp Cortina Musical 72 Barras", "FM", "LATIN", "https://http2.mlstatic.com/D_NQ_NP_838108-MLA31575605575_072019-O.jpg", 2250.0, "G", 2, "BARCHIME CORTINA MUSICAL DE 25 BARRAS LATIN CUSTOM. Emitimos factura A y B", categorias.get(2), null),
                    new Instrumento("Shekeres. Instrumento. Música. Artesanía.", "Azalea Artesanías", "Cuentas de madera", "https://galeriaartesanalpr.com/cdn/shop/files/SHEKERE800LOGO2_2fcbe4be-eb88-4d7c-94f4-e3b619eb623b_600x.jpg", 850.0, "300", 5, "Las calabazas utilizadas para nuestras artesanías son sembradas y cosechadas por nosotros, quienes seleccionamos el mejor fruto para garantizar la calidad del producto y ofrecerle algo creativo y original.", categorias.get(2), null),
                    new Instrumento("Antiguo Piano Aleman Con Candelabros.", "Neumeyer", "Stratus", "https://http2.mlstatic.com/D_NQ_NP_741625-MLA25468412771_032017-O.jpg", 17000.0, "2000", 0, "Buen dia! Sale a la venta este Piano Alemán Neumeyer con candelabros incluidos. Tiene una talla muy bonita en la madera. Una pieza de calidad.", categorias.get(3), null),
                    new Instrumento("Guitarra Ukelele Infantil Grande 60cm", "GUITARRA", "UKELELE", "https://http2.mlstatic.com/D_NQ_NP_602949-MLA32297056646_092019-O.jpg", 500.0, "G", 5, "Material: Plástico smil madera 4 Cuerdas longitud: 60cm, el mejor regalo para usted, su familia y amigos, adecuado para 3-18 años de edad", categorias.get(0), null),
                    ...
                    new Instrumento("Batería Musical Infantil Juguete Niño 9 Piezas Palillos ", "Bateria", "Infantil", "https://http2.mlstatic.com/D_NQ_NP_643960-MLA27368744727_052018-O.jpg", 850.0, "250", 380, "DESCRIPCIÓN: DE 1 A 3 AÑOS. EL SET INCLUYE 5 TAMBORES, PALILLOS Y EL PLATILLO TAL CUAL LAS FOTOS. SONIDOS REALISTAS Y FÁCIL DE MONTAR. MEDIDAS: 40X20X46 CM", categorias.get(2), null)
            );
